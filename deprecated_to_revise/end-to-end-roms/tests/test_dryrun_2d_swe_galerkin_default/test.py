...
class Tester(unittest.TestCase):
    ...
    def test_offline(self):
        ...
        # checking
        #
        gold = {'stateData': {'useTrainingRuns': 'all'}, 'rhsData': {'useTrainingRuns': 'all'}}
    ...
    def test_online(self):
        ...
        gold = {
            ...
            'meshDir': f'{cwd}/fom_mesh', 'numDofsPerCell': 3, \
            'coriolis': -0.5, 'pulsemag': 0.125, 'gravity': 9.8, \
            'finalTime': 5.0, 'stateSamplingFreq': 10, 'rhsSamplingFreq': 100,
        ...
        gold = {
            ...
            'odeScheme': 'RK4', 'timeStepSize': 0.005, \
            'problem': '2d_swe',
            'runId': 0, 'meshDir': f'{cwd}/fom_mesh', \
            'numDofsPerCell': 3, 'coriolis': -0.5, 'pulsemag': 0.125,
