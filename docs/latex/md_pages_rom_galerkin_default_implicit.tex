...
\DoxyCodeLine{}
\DoxyCodeLine{  \textcolor{keyword}{using} ode\_tag = pressio::ode::BDF1;}
\DoxyCodeLine{  \textcolor{keyword}{auto} problem = prom::galerkin::create\_default\_problem<ode\_tag>(fomSystem, decoder, romState, fomReferenceState);}
