...
\end{DoxyEnumerate}
\end{DoxyParagraph}
\hypertarget{md_pages_tutorials_tutorial3_autotoc_md45}{}\doxysection{The shallow water equations}\label{md_pages_tutorials_tutorial3_autotoc_md45}
We consider the shallow water equations on the spatial domain $\Omega = [-\frac{L}{2},\frac{L}{2}] \times [-\frac{L}{2},\frac{L}{2}]$, which comprises the P\+DE system \[ \begin{split} &\frac{\partial h}{\partial t} + \frac{\partial}{\partial x }( h u) + \frac{\partial}{\partial y }( h v) = 0\\ &\frac{\partial h u}{\partial t} + \frac{\partial}{\partial x} (h u^2 + \frac{1}{2} \mu_1 h^2) + \frac{\partial}{\partial y }( h u v) = \mu_3 hv\\ &\frac{\partial h v}{\partial t} + \frac{\partial}{\partial x} (h u v) + \frac{\partial}{\partial y }( h v^2 + \frac{1}{2} \mu_1 h^2) = \mu_3 hu. \end{split} \] In the above, $h : \Omega \rightarrow \mathbb{R}$ is the height of the water surface, $u : \Omega \rightarrow \mathbb{R}$ is the x-\/velocity, and $v : \Omega \rightarrow \mathbb{R}$ is the y-\/velocity. The system has three parameters\+: $\mu_1$ is the gravity parameter, $\mu_2$ controls the magnitude of the initial pulse, and $\mu_3$ controls the magnitude of the Coriolis forcing.\hypertarget{md_pages_tutorials_tutorial3_autotoc_md46}{}\doxysection{Offline phase}\label{md_pages_tutorials_tutorial3_autotoc_md46}
...
\end{DoxyCode}
\hypertarget{md_pages_tutorials_tutorial3_autotoc_md47}{}\doxysubsection{Running the full-\/order model}\label{md_pages_tutorials_tutorial3_autotoc_md47}
...
This script will bring up a live animation of the solution for the first parameter instance.\hypertarget{md_pages_tutorials_tutorial3_autotoc_md48}{}\doxysubsection{Extracting the bases and building the sample mesh}\label{md_pages_tutorials_tutorial3_autotoc_md48}
...
\hypertarget{md_pages_tutorials_tutorial3_autotoc_md49}{}\doxysection{Online phase}\label{md_pages_tutorials_tutorial3_autotoc_md49}
...
This will run the F\+OM and save the solution to file. The F\+OM was tested on a 2.\+7 G\+Hz 12-\/Core Intel Xeon E5 core, and took 152 seconds to run.\hypertarget{md_pages_tutorials_tutorial3_autotoc_md50}{}\doxysubsection{L\+S\+P\+G R\+OM}\label{md_pages_tutorials_tutorial3_autotoc_md50}
