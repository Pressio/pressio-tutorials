...
\end{DoxyEnumerate}
\end{DoxyParagraph}
\hypertarget{md_pages_swe_endtoend_autotoc_md18}{}\doxysection{Prerequisites}\label{md_pages_swe_endtoend_autotoc_md18}
...
\end{DoxyCode}
\hypertarget{md_pages_swe_endtoend_autotoc_md19}{}\doxysection{Step 1\+: Compute F\+O\+M training data}\label{md_pages_swe_endtoend_autotoc_md19}
...
This script will bring up a live animation of the solution for the first parameter instance.\hypertarget{md_pages_swe_endtoend_autotoc_md20}{}\doxysection{Step 2\+: Compute the bases and build the sample mesh}\label{md_pages_swe_endtoend_autotoc_md20}
...
\hypertarget{md_pages_swe_endtoend_autotoc_md21}{}\doxysection{Step 3\+: Run F\+O\+M at test point}\label{md_pages_swe_endtoend_autotoc_md21}
...
\end{DoxyParagraph}
\hypertarget{md_pages_swe_endtoend_autotoc_md22}{}\doxysection{Step 4\+: R\+U\+N a standard L\+S\+P\+G R\+OM}\label{md_pages_swe_endtoend_autotoc_md22}
...
\end{DoxyParagraph}
We immediately note that our {\itshape R\+OM is slower than the F\+O\+M!} This is due to the well-\/known bottleneck associated with nonlinear systems. To gain computational speedups, we need hyper-\/reduction, as shown below.\hypertarget{md_pages_swe_endtoend_autotoc_md23}{}\doxysection{Step 4\+: R\+U\+N the hyper-\/reduced L\+S\+P\+G R\+OM}\label{md_pages_swe_endtoend_autotoc_md23}
