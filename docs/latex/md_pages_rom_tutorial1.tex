...
\end{DoxyParagraph}
\hypertarget{md_pages_rom_tutorial1_autotoc_md7}{}\doxysection{Context}\label{md_pages_rom_tutorial1_autotoc_md7}
...
{\itshape A linear decoder in pressio implements this linear mapping.}\hypertarget{md_pages_rom_tutorial1_autotoc_md8}{}\doxysection{Types Description}\label{md_pages_rom_tutorial1_autotoc_md8}
...
\end{DoxyItemize}\hypertarget{md_pages_rom_tutorial1_autotoc_md9}{}\doxysection{Scenario A\+: your F\+O\+M types are natively supported in pressio}\label{md_pages_rom_tutorial1_autotoc_md9}
...
\DoxyCodeLine{\}}
\end{DoxyCode}
\hypertarget{md_pages_rom_tutorial1_autotoc_md10}{}\doxysection{Scenario B\+: your F\+O\+M types are N\+O\+T natively supported in pressio}\label{md_pages_rom_tutorial1_autotoc_md10}
...
\DoxyCodeLine{\}}
\end{DoxyCode}
\hypertarget{md_pages_rom_tutorial1_autotoc_md11}{}\doxysubsection{The ops struct}\label{md_pages_rom_tutorial1_autotoc_md11}
...
\DoxyCodeLine{\};}
\end{DoxyCode}
\hypertarget{md_pages_rom_tutorial1_autotoc_md12}{}\doxysection{Comments}\label{md_pages_rom_tutorial1_autotoc_md12}
