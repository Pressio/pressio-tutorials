...
class Tester(unittest.TestCase):
    ...
    def test_foms(self):
        ...
        #
        # fom_test_runid_0
        gold = {'inviscidFluxReconstruction': 'Weno3', 'odeScheme': 'BDF1',
                'timeStepSize': 0.01,
        ...
        gold = {'inviscidFluxReconstruction': 'Weno3', \
                'odeScheme': 'BDF1', 'timeStepSize': 0.01,
                ...
                'coriolis': -1.0, 'pulsemag': 0.125, \
                'gravity': 9.8, 'finalTime': 5.0,
                'stateSamplingFreq': 10}
    ...
    def test_online(self):
        ...
        gold = {
            ...
            'nonlinearSolverTolerance': '1e-6', 'problem': '2d_swe', \
            'runId': 0,
            'meshDir': f'{cwd}/offline_rom/sample_mesh_random_0.100', \
            'numDofsPerCell': 3, 'coriolis': -0.5,
        ...
        gold = {
            ...
            'odeScheme': 'BDF1', 'timeStepSize': 0.01,
            'nonlinearSolverName': 'GaussNewton', \
            'nonlinearSolverTolerance': '1e-6', 'problem': '2d_swe', 'runId': 0,
