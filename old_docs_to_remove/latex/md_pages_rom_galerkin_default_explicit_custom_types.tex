...
\end{DoxyParagraph}
\hypertarget{md_pages_rom_galerkin_default_explicit_custom_types_autotoc_md27}{}\doxysection{Custom Data Class}\label{md_pages_rom_galerkin_default_explicit_custom_types_autotoc_md27}
...
\end{DoxyCode}
\hypertarget{md_pages_rom_galerkin_default_explicit_custom_types_autotoc_md28}{}\doxysection{Specialize trait and ops}\label{md_pages_rom_galerkin_default_explicit_custom_types_autotoc_md28}
...
\end{DoxyCode}
\hypertarget{md_pages_rom_galerkin_default_explicit_custom_types_autotoc_md29}{}\doxysection{Main}\label{md_pages_rom_galerkin_default_explicit_custom_types_autotoc_md29}

\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{preprocessor}{\#include "{}pressio/rom\_galerkin.hpp"{}}}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{keyword}{struct }TrivialFomOnlyVelocityCustomTypes}
\DoxyCodeLine{\{}
...
\DoxyCodeLine{}
\DoxyCodeLine{  TrivialFomOnlyVelocityCustomTypes(\textcolor{keywordtype}{int} N): N\_(N)\{\}}
\DoxyCodeLine{}
...
\DoxyCodeLine{    \textcolor{keywordflow}{for} (std::size\_t i=0; i<f.extent(0); ++i)\{}
...
\DoxyCodeLine{}
\DoxyCodeLine{  constexpr \textcolor{keyword}{auto} odescheme = pressio::ode::StepScheme::ForwardEuler;}
\DoxyCodeLine{  \textcolor{keyword}{auto} problem = pressio::rom::galerkin::create\_default\_explicit\_problem}
